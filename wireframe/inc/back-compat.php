 ...
 * @since Twenty Seventeen 1.0
 */
function wireframe_switch_theme() {
	switch_theme( WP_DEFAULT_THEME );
	unset( $_GET['activated'] );
	add_action( 'admin_notices', 'wireframe_upgrade_notice' );
}
add_action( 'after_switch_theme', 'wireframe_switch_theme' );
...
add_action( 'load-customize.php', 'wireframe_customize' );
