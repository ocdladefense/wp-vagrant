 ...
 */
function wireframe_custom_colors_css() {
	 ...
	 */
	$saturation         = absint( apply_filters( 'wireframe_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.wireframe-front-page) .entry-title,
...
.colors-custom.wireframe-front-page .panel-content .recent-posts article,
...
.colors-custom.wireframe-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'wireframe_custom_colors_css', $css, $hue, $saturation );
}
